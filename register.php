...
<div id="background">
    ...
    <div id="loginContainer">
        ...
        <div id="inputContainer">
            <form id="loginForm" action="register.php" method="POST">
                ...
                <p>
                    ...
                    <input id="loginPassword" name="loginPassword" type="password" placeholder="e.g. Your password"
                           required>
                </p>
            ...
            <form id="registerForm" action="register.php" method="POST">
                ...
                <p>
                    ...
                    <input id="username" name="username" type="text" placeholder="e.g. JakeBaker"
                           value="<?php getInputValue('username') ?>" required>
                </p>
                <p>
                    <?php echo $account->getError(Constants::$firstNameCharacters); ?>
                    <label for="firstName">First Name</label>
                    <input id="firstName" name="firstName" type="text" placeholder="e.g. Jake"
                           value="<?php getInputValue('firstName') ?>" required>
                </p>
                <p>
                    <?php echo $account->getError(Constants::$lastNameCharacters); ?>
                    <label for="lastName">Last Name</label>
                    <input id="lastName" name="lastName" type="text" placeholder="e.g. Baker"
                ...
                <p>
                    ...
                    <input id="email" name="email" type="email" placeholder="e.g. jakebaker@gmail.com"
                           value="<?php getInputValue('email') ?>" required>
                </p>
                <p>
                    <label for="email2">Confirm Email</label>
                    <input id="email2" name="email2" type="email" placeholder="e.g. jakebaker@gmail.com"
        ...
        <div id="loginText">
            ...
            <h2>Listin to loads of songs for free.</h2>
            <ul>
